...
def print_help():
  print "Usage:",sys.argv[0],"[options]"
	print "\n \
		...
		-h|--help usage"
	print "*" * 150
	print "Usage:",sys.argv[0]," --live --url=\"http://cal.vip.paypal.com/2011/06-June/02/01:00:00/logs/webscr/10/191/13/110/den1cal35/eb-sql-log_02-06-2011_00-30-55_0x0.68143304.433266.mul.gz\""
	print "				OR"
	print "Usage:",sys.argv[0],"-l --url=\"http://cal.vip.paypal.com/2011/06-June/02/01:00:00/logs/webscr/10/191/13/110/den1cal35/eb-sql-log_02-06-2011_00-30-55_0x0.68143304.433266.mul.gz\""
	print "				OR"
	print "Usage:",sys.argv[0],"--url=\"http://cal.vip.paypal.com/2011/06-June/02/01:00:00/logs/webscr/10/191/13/110/den1cal35/eb-sql-log_02-06-2011_00-30-55_0x0.68143304.433266.mul.gz\""
	print "				OR"
	print "Usage:",sys.argv[0],"-u \"http://cal.vip.paypal.com/2011/06-June/02/01:00:00/logs/webscr/10/191/13/110/den1cal35/eb-sql-log_02-06-2011_00-30-55_0x0.68143304.433266.mul.gz\""
	print "				OR"
	print "Usage:",sys.argv[0],"--file=calclientlogfile.log --stage=stage2sc5407"
	print "				OR"
	print "Usage:",sys.argv[0],"-f calclientlogfile.log -s stage2sc5407"
	print "				OR"
